    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-2xl mx-auto px-5 py-8 space-y-4">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
          <h2 className="font-black text-slate-900 text-base">About</h2>
          <div className="flex flex-wrap gap-2">
            ...
            <span className="text-xs font-bold px-3 py-1 rounded-full bg-slate-100 text-slate-600 capitalize">
              {request.gender}
            </span>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-3">
          <h2 className="font-black text-slate-900 text-base">Looking For</h2>
        ...
        {waLink && (
          <div className="bg-white rounded-2xl border border-slate-200 p-6">
            <h2 className="font-black text-slate-900 text-base mb-4">
              Contact
            </h2>
            <a
              href={waLink}
